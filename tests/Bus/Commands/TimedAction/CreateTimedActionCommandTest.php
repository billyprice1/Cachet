...
class CreateTimedActionCommandTest extends AbstractTestCase
{
    ...
    protected function getObjectAndParams()
    {
        ...
        $object = new CreateTimedActionCommand($params['name'], $params['description'], $params['active'], $params['start_at'], $params['timezone'], $params['window_length'], $params['completion_latency'], $params['timed_action_group_id']);
